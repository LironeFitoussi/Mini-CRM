...
import useUsers from "../../queryhooks/useUsers";
...
const CreateLeadModal = ({ open, onClose, handleCreateLead }) => {
  ...
  const validateFields = () => {
    ...
    if (selectedDonators.length === 0)
      newErrors.selectedDonators = "At least one donator is required";
    setErrors(newErrors);
    ...
    <Modal open={open} onClose={onClose}>
      ...
      >
        ...
        <Autocomplete
          ...
          onChange={(event, value) => setOwner(value?._id || "")}
          renderInput={(params) => (
            <TextField
              {...params}
              label="Telepro"
